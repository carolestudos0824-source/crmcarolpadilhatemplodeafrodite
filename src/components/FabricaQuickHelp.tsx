...
const PUBLIC_TOPICS: PublicTopic[] = [
  { id: "preco", title: "Preço e oferta", excerpt: "R$197 por 1 ano de acesso. Parcelamento disponível no cartão. Liberação após confirmação do pagamento.", keywords: ["preco", "preço", "valor", "quanto custa", "oferta", "promoção", "parcelar", "1 ano", "acesso"], to: "/precos" },
