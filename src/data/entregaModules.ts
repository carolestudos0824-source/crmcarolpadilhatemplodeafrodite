...
Remova enrolação, frases difíceis e promessas irreais.`,
  ...
  },
  {
    ...
    objective: "Criar criativos para anúncios pagos simples (sem rodar campanha real aqui).",
    whenLovableDirect: "Quando oferta, página, checkout e entrega já estão prontos e a oferta foi minimamente validada organicamente.",
