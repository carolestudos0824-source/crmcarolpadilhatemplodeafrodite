...
export const A_SACERDOTISA: ArcanoMaiorEditorial = {
  ...
  deepDive: {
    ...
    symbolism: "As duas colunas B (Boaz) e J (Jachin) são as colunas do Templo de Salomão, representando força e estabilidade. A Sacerdotisa senta entre elas, em equilíbrio perfeito. O véu com romãs (fertilidade) e palmeiras (vitória) separa o mundo profano do sagrado.",
