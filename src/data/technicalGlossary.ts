...
export const TECHNICAL_GLOSSARY: TechnicalTerm[] = [
  ...
  },
  {
    ...
    whyItMatters: "Permite testar mudanças sem afetar o público real.",
  ...
  },
  {
    ...
    whyItMatters: "Reflete confiança. Apps que caem muito perdem público.",
    whenItEnters: "Importa de verdade quando você tem pessoas reais pagando.",
    worryNow: "com-usuarios",
  },
