...
export const TECHNICAL_GLOSSARY: TechnicalTerm[] = [
  ...
  // ===== Começo / versão inicial =====
  {
    ...
    category: "comeco",
    simple: "A versão mais simples do app que já entrega valor para a usuária.",
  ...
  // ===== Telas, fluxo e experiência =====
  {
    ...
    name: "Fluxo do app",
    category: "telas",
    simple: "O caminho que a usuária percorre dentro do app, de tela em tela.",
    whyItMatters: "Um fluxo confuso faz a usuária desistir antes de chegar no objetivo.",
  ...
  {
    slug: "ux",
    name: "UX (experiência da usuária)",
    category: "telas",
    simple: "Como a pessoa se sente usando o app: fácil, claro, sem fricção.",
    whyItMatters: "Um app bonito mas confuso não vende. UX boa retém usuária.",
  ...
  },
  {
    ...
    whyItMatters: "Uma tela vazia bem feita orienta a usuária a dar o próximo passo.",
  ...
  // ===== Mobile / PWA / Android / iOS =====
  {
    ...
    whenItEnters: "Quando você quiser que a aluna ou cliente acesse pelo celular com mais praticidade.",
    worryNow: "em-breve",
    relatedModuleId: "publicar",
  },
  {
  ...
  },
  {
    ...
    category: "mobile",
    simple: "Atalho que a usuária pode salvar na tela do celular para abrir o app mais rápido.",
  ...
  },
  {
    ...
    category: "mobile",
    simple: "Notificação enviada para o celular ou navegador da usuária.",
    whyItMatters: "Pode lembrar a usuária de voltar ao app.",
  ...
  },
  {
    ...
    name: "Geolocalização",
    category: "mobile",
    simple: "Recurso que identifica a localização aproximada da usuária.",
