...
-- Rodada 2: extend admin_set_access with optional _duration_days
  ...
  ON CONFLICT (user_id) DO UPDATE
    SET has_access = EXCLUDED.has_access,
        ...
        access_expires_at = CASE
          WHEN EXCLUDED.has_access = false THEN public.user_access.access_expires_at
          WHEN _duration_days IS NOT NULL THEN EXCLUDED.access_expires_at
...
-- Rodada 2: extend admin_grant_access_from_sale with optional _duration_days
